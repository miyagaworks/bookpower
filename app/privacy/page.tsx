...
export const metadata = {
  title: 'プライバシーポリシー | 著力',
  description: '株式会社Senriganのプライバシーポリシー',
};
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-8 text-justify">
              株式会社Senrigan（以下「当社」といいます）は、当社が提供するサービス（以下「本サービス」といいます）における個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。
            </p>
            ...
            <section className="mb-10">
              ...
              <div className="bg-background p-6 rounded-lg">
                <p className="text-gray-800 font-bold mb-2">株式会社Senrigan</p>
                <p className="text-gray-800">住所：〒731-0137 広島県広島市安佐南区山本2-3-35</p>
                <p className="text-gray-800">メールアドレス：info[at]bookpower[dot]jp</p>
                <p className="text-gray-600 text-sm mt-2">※ [at]を@に、[dot]を.に置き換えてください</p>
              </div>
            </section>
